from .dashboard_view import dashboard_view  # NOQA: F401
from .suite_detail_view import suite_detail_view  # NOQA: F401
from .suite_report_view import suite_report_view  # NOQA: F401
from .suite_list_view import suite_list_view  # NOQA: F401
