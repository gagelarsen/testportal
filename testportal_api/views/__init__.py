...
from .test_case_views import upload_multiple_test_cases, TestCaseDetail  # NOQA: F401
...
from .test_result_views import delete_test_results_for_date_and_suite, upload_test_results, TestResultDetail, TestResultList  # NOQA: F401
